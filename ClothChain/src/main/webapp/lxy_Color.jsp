                    ...
                    <div >
                        ...
                        <table class="table table-bordered table-condensed table-hover ">
                            ...
                            <tr  v-for="sam in colorlist">
                                ...
                                <td>{{sam.colorstr}}</td>
                                <td>{{sam.url}}</td><%--描述--%>
                                <td><a  class='btn btn-white  btn-xs btn-bold glyphicon glyphicon-pencil' data-toggle='modal' data-target='#myModal' @click='getOne(sam.colorid)'>查看</a></td>
                            </tr>
                    ...
                    <div class="modal-body" >
                        <form class="form-horizontal form-label-left" id="myform">
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">颜色编号</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text"  name="colorid" :value="mat.colorid"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">颜色名称</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text"  name="colorname" :value="mat.colorname"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <div class="input-group demo2">
                                        <input type="text" value="#e01ab5" class="form-control" name="colorstr" :value="mat.colorstr"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" name="url" :value="mat.url">
                                </div>
                            </div>
                        </form>
